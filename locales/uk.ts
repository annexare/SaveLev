...
export const uk: Translation = {
  ...
  fundraisingClosed: 'Збір коштів наразі закритий, будь ласка перейдіть у мої соціальні мережі за детальною інформацією. Я щиро дякую кожному з вас за таку підтримку!',
